...
export default {
    ...
    methods: {
        ...
        getProduct: function (id) {
            ...
            axios
                .get(this.baseURL + "api/v1/product/" + id)
    ...
    computed: {
        ...
        subcategories: function () {
            ...
            for (var i in data.getSubcategories()) {
                if (
                    data.getSubcategories()[i]["category_id"] ==
                    this.category_id
                )
        ...
        product_quantity: {
            get: function () {
                return data.getProduct().product_quantity
                    ? data.getProduct().product_quantity
                    : 0;
            },
            set: function (value) {
                if (value < 1) data.getProduct().product_quantity = 0;
                else data.getProduct().product_quantity = value;
            },
        },
