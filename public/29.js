...
/* harmony default export */ __webpack_exports__["default"] = ({
   ...
   */
		submit: function submit() {
			...
			var notif = util.notify(util.getProgressbarMessage('Mise à jour des sous-catégories', 0), 'loading');
			this.startLoading();
			var vm = this;
			$('#subcatform').ajaxSubmit({
				...
				uploadProgress: function uploadProgress(a, b, c, d) {
					notif.update('message', util.getProgressbarMessage('Mise à jour des catégories', d));
				}
			});
		},
          ...
          [
            ...
            _c("div", { staticClass: "col-md-8" }, [
              _c("div", { staticClass: "form-group" }, [
                _c("label", [_vm._v("Sélectionner Catégorie")]),
                _vm._v(" "),
                _c(
                  "select",
                  {
                  ...
                  [
                    _c("option", { attrs: { value: "0", disabled: "" } }, [
                      _vm._v("-- Aucune Catégorie Sélectionnée--")
                    ]),
                    _vm._v(" "),
